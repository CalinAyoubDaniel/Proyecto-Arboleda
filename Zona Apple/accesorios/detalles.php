		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">ZONA APPLE</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./accesorios.php" target="_blank">Accesorios</a></li>
								<li class="linea"><a href="../repuestos/repuestos.php" target="_blank">Repuestos</a></li>
							</ul>
						</li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from accesorios_iphone where id=".$_REQUEST['id']) or die ("Error en la consulta");
