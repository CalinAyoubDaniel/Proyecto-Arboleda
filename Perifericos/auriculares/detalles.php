		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./auriculares.php" target="_blank">Auriculares</a></li>
							</ul>
						</li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from auriculares where id=".$_REQUEST['id']) or die ("Error en la consulta");
