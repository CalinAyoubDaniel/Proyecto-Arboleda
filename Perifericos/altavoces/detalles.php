		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./altavoces.php" target="_blank">Altavoces</a></li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from altavoces where id=".$_REQUEST['id']) or die ("Error en la consulta");
