					...
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="../multifuncion/multifunciones.php" target="_blank">Multifunciones</a></li>
								<li class="linea"><a href="../altavoces/altavoces.php" target="_blank">Altavoces</a></li>
								<li class="linea"><a href="#" target="_blank">Teclados</a></li>
				...
				<div id="tabla">
					...
					?>
								...
								<tr>
									...
									<h3 class="titulos"><?php echo $f['nombre'];?></h3>
									<h3 class="titulos"><?php echo $f['precio'];?><span>€</span></h3>
									<a href="./php/detalles.php?id=<?php echo $f['id'];?>" target="_blank">Ver</a>
