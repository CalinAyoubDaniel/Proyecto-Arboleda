			...
			<div id="cuerpo">
				<nav >
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								<li class="linea"><a href="../monitores/monitores.php" target="_blank">Monitores</a></li>
								<li class="linea"><a href="../impresoras/impresoras.php" target="_blank">Impresoras</a></li>
								<li class="linea"><a href="#" target="_blank">Multifunciones</a></li>
								<li class="linea"><a href="../altavoces/altavoces.php" target="_blank">Altavoces</a></li>
								<li class="linea"><a href="../teclados/teclados.php" target="_blank">Teclados</a></li>
								<li class="linea"><a href="../ratones/ratones.php" target="_blank">Ratones</a></li>
								<li class="linea"><a href="../auriculares/auriculares.php" target="_blank">Auriculares</a></li>
							</ul>
						</li>
						<li class="linea"><a href="">ZONA APPLE</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="../../Zona Apple/altavoces/alt.php" target="_blank">Altavoces</a></li>
								<li class="linea"><a href="../../Zona Apple/aur/auriculares.php" target="_blank">Auriculares</a></li>
				...
				<div id="tabla">
					...
					<?php
						...
						$re = mysql_query("select * from multifunciones")or die(mysql_error());
						$cont = 1;
