			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">SMARTPHONES</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./protectores.php" target="">Protectores de Pantalla</a></li>
				...
				<div id="tabla">
					...
					<?php
						...
						$re = mysql_query("select * from productos where tipo = 'protectores_pantalla'")or die(mysql_error());
						$cont = 1;
