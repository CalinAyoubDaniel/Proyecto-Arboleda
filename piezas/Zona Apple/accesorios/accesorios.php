	...
	<body>
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">ZONA APPLE</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="#" target="">Accesorios</a></li>
				...
				<div class="oferta"><h3>Accesorios</h3></div>
				<div id="tabla">
					<table>
						<tr>
					<?php
						include "../../../php/conexion.php";
						$re = mysql_query("select * from productos where tipo = 'accesorios_iphone'")or die(mysql_error());
						$cont = 1;
