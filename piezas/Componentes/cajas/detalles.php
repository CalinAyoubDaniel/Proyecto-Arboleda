		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul>
						...
						<li class="linea"><a href="">COMPONENTES</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./cajas.php">Cajas/Torres</a></li>
							</ul>
						</li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from productos where tipo = 'torres' and  id=".$_REQUEST['id']) or die ("Error en la consulta");
