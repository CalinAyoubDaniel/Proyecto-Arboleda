		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./teclados.php" target="">Teclados</a></li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from productos where tipo = 'teclados' and id=".$_REQUEST['id']) or die ("Error en la consulta");
