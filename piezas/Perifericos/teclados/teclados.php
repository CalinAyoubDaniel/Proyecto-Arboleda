	...
	<body>
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">COMPONENTES</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="../../Componentes/memorias ram/ram.php" target="">Memoria RAM</a></li>
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								<li class="linea"><a href="../monitores/monitores.php" target="">Monitores</a></li>
								<li class="linea"><a href="../impresoras/impresoras.php" target="">Impresoras</a></li>
								<li class="linea"><a href="../multifuncion/multifunciones.php" target="">Multifunciones</a></li>
								<li class="linea"><a href="../altavoces/altavoces.php" target="">Altavoces</a></li>
								<li class="linea"><a href="#" target="">Teclados</a></li>
								<li class="linea"><a href="../ratones/ratones.php" target="">Ratones</a></li>
								<li class="linea"><a href="../auriculares/auriculares.php" target="">Auriculares</a></li>
							</ul>
						</li>
						<li class="linea"><a href="">ZONA APPLE</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="../../Zona Apple/altavoces/alt.php" target="">Altavoces</a></li>
								<li class="linea"><a href="../../Zona Apple/aur/auriculares.php" target="">Auriculares</a></li>
				...
				<div class="oferta"><h3>Altavoces</h3></div>
				<div id="tabla">
					<table>
						<tr>
					<?php
						include "../../../php/conexion.php";
						$re = mysql_query("select * from productos where tipo = 'teclados'")or die(mysql_error());
						$cont = 1;
					...
					?>	
								<td>
									...
									<a href="./detalles.php?id=<?php echo $f['id'];?>" target="">Ver</a>
								</td>
					<?php
							$cont++;
							}else{
					?>
								...
								<tr>
									...
									<h3 class="titulos"><?php echo $f['nombre'];?></h3>
									<h3 class="titulos"><?php echo $f['precio'];?><span>€</span></h3>
									<a href="./php/detalles.php?id=<?php echo $f['id'];?>" target="">Ver</a>
