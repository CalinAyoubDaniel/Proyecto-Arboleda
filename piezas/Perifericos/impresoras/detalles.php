		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./impresoras.php" target="">Impresoras</a></li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from productos where tipo = 'impresoras' and id=".$_REQUEST['id']) or die ("Error en la consulta");
