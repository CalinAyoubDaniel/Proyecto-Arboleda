	...
	<body>
		<div id="contenido">
			...
			<div id="cuerpo">
				<nav >
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								<li class="linea"><a href="#" target="">Monitores</a></li>
				...
				<div class="oferta"><h3>Monitores</h3></div>
				<div id="tabla">
					<table>
						<tr>
					<?php
						include "../../../php/conexion.php";
						$re = mysql_query("select * from productos where tipo = 'monitores'")or die(mysql_error());
						$cont = 1;
