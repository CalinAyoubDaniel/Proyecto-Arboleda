		...
		<div id="contenido">
			...
			<div id="cuerpo">
				<nav >
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								<li class="linea"><a href="./monitores.php" target="">Monitores</a></li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from productos where tipo = 'monitores' and id=".$_REQUEST['id']) or die ("Error en la consulta");
