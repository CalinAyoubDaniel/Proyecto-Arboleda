	...
	<body>
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="#" target="">Multifunciones</a></li>
								<li class="linea"><a href="../altavoces/altavoces.php" target="">Altavoces</a></li>
								<li class="linea"><a href="../teclados/teclados.php" target="">Teclados</a></li>
				...
				<div class="oferta"><h3>Multifunciones</h3></div>
				<div id="tabla">
					<table>
						<tr>
					<?php
						include "../../../php/conexion.php";
						$re = mysql_query("select * from productos where tipo = 'multifunciones'")or die(mysql_error());
						$cont = 1;
