	...
	<body>
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./auriculares.php" target="">Auriculares</a></li>
							</ul>
						</li>
				...
				<div class="oferta"><h3>Auriculares</h3></div>
				<div id="tabla">
					<table>
						<tr>
					<?php
						include "../../../php/conexion.php";
						$re = mysql_query("select * from productos where tipo = 'auriculares'")or die(mysql_error());
						$cont = 1;
