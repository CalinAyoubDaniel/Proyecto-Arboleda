		...
		<div id="contenido">
			...
			<div id="cuerpo">
				<nav >
					<ul >
						...
						<li class="linea"><a href="">SMARTPHONES</a>
							<ul class="nav2">
								<li class="linea"><a href="./telefonos.php" target="_blank">Smartphones</a></li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from telefonos where id=".$_REQUEST['id']) or die ("Error en la consulta");
