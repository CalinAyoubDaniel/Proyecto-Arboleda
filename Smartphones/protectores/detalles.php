		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">COMPONENTES</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="../../Componentes/cajas.php" target="_blank">Cajas/Torres</a></li>
							</ul>
						</li>
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="../../Perifericos/auriculares.php" target="_blank">Auriculares</a></li>
							</ul>
						</li>
						<li class="linea"><a href="">ZONA APPLE</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="../../Zona Apple/repuestos.php" target="_blank">Repuestos</a></li>
							</ul>
						</li>
						<li class="linea"><a href="">SMARTPHONES</a>
							<ul class="nav2">
								<li class="linea"><a href="../telefonos/telefonos.php" target="_blank">Smartphones</a></li>
								<li class="linea"><a href="../fundas/fundas.php" target="_blank">Fundas</a></li>
								<li class="linea"><a href="./protectores.php" target="_blank">Protectores de Pantalla</a></li>
								<li class="linea"><a href="../tarjetas/tarjetas.php" target="_blank">Tarjetas MicroSD</a></li>
								<li class="linea"><a href="../powerbanks/power.php" target="_blank">Powerbanks</a></li>
							</ul>
						</li>
					</ul>
				</nav>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from protectores_pantalla where id=".$_REQUEST['id']) or die ("Error en la consulta");
