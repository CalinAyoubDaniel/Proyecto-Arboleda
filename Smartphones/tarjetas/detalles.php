		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">SMARTPHONES</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="../protectores/protectores.php" target="_blank">Protectores de Pantalla</a></li>
								<li class="linea"><a href="../tarjetas.php" target="_blank">Tarjetas MicroSD</a></li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from tarjetassd where id=".$_REQUEST['id']) or die ("Error en la consulta");
