		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">COMPONENTES</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./discos.php" target="_blank">Discos Duros</a></li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from discosduros where id=".$_REQUEST['id']) or die ("Error en la consulta");
