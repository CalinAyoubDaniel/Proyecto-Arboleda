		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">COMPONENTES</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./graficas.php" target="_blank">Tarjetas Gráficas</a></li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from graficas where id=".$_REQUEST['id']) or die ("Error en la consulta");
