	...
	<body>
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">COMPONENTES</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="#" target="_blank">Tarjetas Gráficas</a></li>
				...
				<div class="oferta"><h3>Tarjetas Graficas</h3></div>
				<div id="tabla">
					<table>
						<tr>
					<?php
						include "../../php/conexion.php";
						$re = mysql_query("select * from graficas")or die(mysql_error());
						$cont = 1;
