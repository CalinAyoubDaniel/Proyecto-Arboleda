...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Fuentes Alimentación</title>
	...
	<body>
		<div id="contenido">
			...
			<div id="cuerpo">
				<nav >
					<ul >
						...
						<li class="linea"><a href="">COMPONENTES</a>
							<ul class="nav2">
								<li class="linea"><a href="../placas/placas.php" target="_blank">Placas base</a></li>
								...
								<li class="linea"><a href="../memorias ram/ram.php" target="_blank">Memoria RAM</a></li>
								<li class="linea"><a href="#" target="_blank">Fuentes de A.</a></li>
						...
						<li class="linea"><a href="">PERIFERICOS</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="../../Perifericos/multi/multi.php" target="_blank">Multifunciones</a></li>
				...
				<div class="oferta"><h3>Fuentes Alimentación</h3></div>
				<div id="tabla">
					<table>
						<tr>
					<?php
						include "../../php/conexion.php";
						$re = mysql_query("select * from fuentesalimentacion")or die(mysql_error());
						$cont = 1;
