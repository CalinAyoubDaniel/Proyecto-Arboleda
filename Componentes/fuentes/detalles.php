		...
		<div id="contenido">
			...
			<div id="cuerpo">
					...
					<ul >
						...
						<li class="linea"><a href="">COMPONENTES</a>
							<ul class="nav2">
								...
								<li class="linea"><a href="./fuentes.php" target="_blank">Fuentes de A.</a></li>
				...
				<div id="tercero">
					...
					$cons = mysql_query("select * from fuentesalimentacion where id=".$_REQUEST['id']) or die ("Error en la consulta");
